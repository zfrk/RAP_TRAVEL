...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zfri_travel_m.
...
**********************************************************************
  METHOD validate_customer.
    ...
    READ ENTITY zfri_travel_m\\travel FROM VALUE #(
...
********************************************************************************
  METHOD set_status_completed.
    ...
    MODIFY ENTITIES OF zfri_travel_m IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF zfri_travel_m IN LOCAL MODE
         ENTITY travel
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zfri_travel_m FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD calculatetravelkey.
    ...
    "Get max travelID
    SELECT SINGLE FROM zfr_travel FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).
