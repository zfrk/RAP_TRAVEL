CLASS zfr_cl_generate_travel_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zfr_cl_generate_travel_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF zfr_travel.
...
*   delete existing entries in the database table
    DELETE FROM zfr_travel.

*   insert the new table entries
    INSERT zfr_travel FROM TABLE @itab.
